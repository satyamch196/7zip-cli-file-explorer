# Increase efficiency by generating key value pair of current directory only.
from re import findall
file="/sdcard/Download/Quick Share/7zip.txt" #'/sdcard/Download/1DM/Compressed/aik_index.txt'
red="\033[31m"
green="\033[32m"
reset="\033[0m"
